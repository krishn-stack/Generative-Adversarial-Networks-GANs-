...
class ContractingBlock(nn.Module):
    ...
    def __init__(self, input_channels):
        ...
        #### START CODE HERE ####
        self.conv1 = nn.Conv2d(input_channels, input_channels * 2, kernel_size=(3, 3))
        self.conv2 = nn.Conv2d(input_channels * 2, input_channels * 2, kernel_size=(3, 3))
...
def crop(image, new_shape):
    ...
    #### START CODE HERE ####
    start_h = (image.shape[2] - new_shape[2]) // 2 
    start_w = (image.shape[3] - new_shape[3]) // 2
